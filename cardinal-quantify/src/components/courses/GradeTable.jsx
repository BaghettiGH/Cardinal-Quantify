...
import EstimaeButton from './EstimaeButton';
...
function GradeTable({setFinalGrade, mode}) {
    ...
    return (
        <div className="grade-table">
            <h2>{mode === 'estimate' ? 'Estimate Grade' : 'Compute Grade'}</h2>
            <table className="grade-table">
                <thead>
                    <tr>
                        ...
                        <th>Grade</th>
                        <th>Weight</th>
                        {mode === 'estimate' && <th>Required Grade</th>}
                        <th><CalculateButton assignments={assignments} setFinalGrade={setFinalGrade} mode={mode} /></th>
                        {mode === 'estimate' && <th><EstimaeButton assignments={assignments} setFinalGrade={setFinalGrade} /></th>}
                    </tr>
                </thead>
                <tbody>
                    {assignments.map((assignment) => {
                        ...
                        return(                    
                            <tr key={assignment.id}>
                                ...
                                {mode === 'estimate' && (
                                    <td>
                                        <div className="required-grade-div">
                                            {assignment.requiredGrade !== undefined ? assignment.requiredGrade.toFixed(2) : "--"}
                                        </div>
                                    </td>
                                )}
                            </tr>
